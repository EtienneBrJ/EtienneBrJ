...
def getKlimaPrice():
    ...
    URL = config.API_SUSHISWAP + '?chainID=137&action=get_pair&pair=' + config.USDC_KLIMA_PAIR_SUSHISWAP
...
def main(address):
    ...
    klima_eur = '{} EUR'.format(int(c.convert((balance_sKlima * klimaPrice), 'USD', 'EUR')))
